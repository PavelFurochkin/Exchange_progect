...
from DTO import ExchangeRatesDTO, ExchangeCurrencyDTO
...
class Mapper:
    ...
    def presenting_exchange_rate(self, id_base: int, id_target: int,
        ...
        # Формирует представление обменного курса через DTO
        formatted_data = ExchangeCurrencyDTO(__base_currency, __target_currency, rate,
